...
See https://codeberg.org/AlexanderEngelmark/mne-tesa/src/branch/main/tutorial.ipynb for a tutorial on how to use the functions.
...
.. autosummary::
   ...
   mne_tesa.tesa_find_pulse
   mne_tesa.tesa_notch_filter_epochs
   mne_tesa.tesa_bandpass_filter_epochs
   mne_tesa.tesa_interp_cubic_spline
   mne_tesa.tesa_replace_constant_amplitude
   mne_tesa.tesa_class_comp
...
.. autosummary::
   ...
   plotly_evoked.tesa_plotly_evoked
   plotly_evoked.tesa_plotly_gfp
